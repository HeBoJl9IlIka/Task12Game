...
namespace IJunior.TypedScenes
{
    ...
    public class Base : TypedScene
    {
        
        private const string _sceneName = "Base";
        
        public static void Load(Item[] argument, LoadSceneMode loadSceneMode = LoadSceneMode.Single)
        {
            LoadScene(_sceneName, loadSceneMode, argument);
        }
        
        public static UnityEngine.AsyncOperation LoadAsync(Item[] argument, LoadSceneMode loadSceneMode = LoadSceneMode.Single)
        {
